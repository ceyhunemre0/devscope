    ...
    async def complete(
        ...
        *,
        ...
        for provider in self._chain:
            ...
            req = LLMRequest(
                prompt=prompt, model=model, purpose=purpose,
            ...
            for attempt in range(self._max_retries):
                ...
                try:
                    ...
                    if attempt == self._max_retries - 1:
                        self._record(provider.name, model, purpose, None, None,
                                     None, _ms(start), False, str(exc))
                        break
                    ...
                    self._record(provider.name, model, purpose,
                                 resp.prompt_tokens, resp.output_tokens,
                                 resp.cost_usd, _ms(start), True, None)
                    return resp
